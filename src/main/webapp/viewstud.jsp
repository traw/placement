...
<%
    String studIdString = (String)request.getParameter("studID");
    if (studIdString == null || studIdString.isEmpty()){
        out.println("studIdString: "+studIdString);
        return;
    }
    long studentId = Long.getLong(studIdString);
