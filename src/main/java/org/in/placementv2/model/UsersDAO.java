 ...
 * 
 * @see org.in.placementv2.model.Users
 * @author MyEclipse Persistence Tools
 */
public class UsersDAO extends SkillDao {
	...
	public Users findById(java.lang.String id) {
		...
		try {
			Users instance = (Users) getSession().get(
					"org.in.placementv2.model.Users", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = getSession()
					.createCriteria("org.in.placementv2.model.Users")
